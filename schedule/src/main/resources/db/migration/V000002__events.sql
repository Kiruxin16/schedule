...
INSERT INTO club_events(discipline,coach_name,event_date,start_time,duration,hall_id,comments) VALUES
        ...
        ('КИКБОКСИНГ','Соколова Алена', '2023-08-07', '19:00:00','90', 5,''),
        ...
        ('ТАЙ-БО',  'Васильева Кристина', '2023-08-08', '17:30:00','30', 5,''),
        ...
        ('КИКБОКСИНГ' , 'Соколова Алена', '2023-08-09', '19:00:00', '90', 5, ''),
        ...
        ('ТАЙ-БО', 'Васильева Кристина', '2023-08-10', '17:30:00', '30', 5, ''),
        ...
        ('КИКБОКСИНГ' , 'Соколова Алена', '2023-08-11', '19:00:00', '90', 5, ''),
        ...
        ('КИКБОКСИНГ','', '2023-08-12', '20:30:00', '90', 5, '(детская группа)'),
        ...
        ('КИКБОКСИНГ' , 'Соколова Алена', '2023-08-13', '17:30:00', '90', 5, ''),
